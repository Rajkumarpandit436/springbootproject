...
* The original package name 'com.microservice.stocker-service' is invalid and this project uses 'com.microservice.stockerservice' instead.
...
* [Spring for Apache Kafka](https://docs.spring.io/spring-boot/docs/3.0.0-M4/reference/htmlsingle/#messaging.kafka)
